...
const styles = {
  ...
  input: { width: '100%', padding: '14px', borderRadius: '12px', background: '#0a0a0a', border: '1px solid #333', color: 'white', fontSize: '16px', outline: 'none', transition: 'border 0.3s' },
  singerSelector: { display: 'flex', background: '#0a0a0a', padding: '4px', borderRadius: '12px', border: '1px solid #333' },
